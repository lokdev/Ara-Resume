        ...
        return(
            <div className="socialbutton" >
               <a href="https://www.linkedin.com/in/aracelicontis/">
                   <i class="fab fa-linkedin mr-2 fa-3x " data-toggle="tooltip" data-placement="top" title="Linkedin">
                    </i>
                </a>
                <a href="mailto:araceli.contis@gmail.com">
                    <i class="fa fa-envelope  fa-3x ml-2" data-toggle="tooltip" data-placement="top" title="Send e-mail to Araceli">
                    </i>
                </a>
